...
OBJECTS=main.o keyboard.o rotate.o light.o add_light.o add_primitive.o add_primitive2.o intersection.o new_intersection.o trace.o vector.o render.o math.o  supersampling.o scenes.o object.o color.o init.o parser.o jsmn.o
