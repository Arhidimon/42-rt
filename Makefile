...
OBJECTS=main.o keyboard.o rotate.o light.o add_light.o add_primitive.o intersection.o trace.o vector.o render.o math.o  supersampling.o scenes.o object.o color.o  init.o parser.o parser.1.o parser.2.o parser.3.o parser.4.o add_primitive2.o new_intersection.o jsmn.o 
